...
test_image_paths = [f for f in listdir('video_frames/') if '.jpg' in f]
...
for clothing_image in test_image_paths:
    ...
    write_res = cv2.imwrite(f'video_frames_output/{file_name}', result)


# annotated_images = [
#    f'video_frames_output/{f}' for f in test_df.file_name.unique()]
